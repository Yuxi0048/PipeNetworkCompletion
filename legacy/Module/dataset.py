...
def data_transform(data, seed=None):
    ...
    new_data[MH_EDGE_TYPE].edge_index = torch.concat([pos_edge_sample, neg_edge_sample], axis= 1)
    new_data[MH_EDGE_TYPE].edge_label_index = torch.concat([pos_edge_sample, neg_edge_sample ], axis= 1)
